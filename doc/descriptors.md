# Support for Output Descriptors in Buttcoin Core

Since Buttcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Buttcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Buttcoin Core wallets, a convenience function `combo` is
