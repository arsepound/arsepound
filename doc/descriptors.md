# Support for Output Descriptors in Arsepound Core

Since Arsepound Core v0.17, there is support for Output Descriptors. This is a
...
on Arsepound's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Arsepound Core wallets, a convenience function `combo` is
