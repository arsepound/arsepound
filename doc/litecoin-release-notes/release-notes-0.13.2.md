Buttcoin Core version 0.13.2 is now available from:
  ...
  <https://download.buttcoin.org/buttcoin-0.13.2.1/>
...
Buttcoin Core 0.13.2 will have a strict maximum size on the mempool. The
...
Buttcoin Core 0.13.2 also introduces new default policy limits on the length and
...
- `buttcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `buttcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Bitcoin and Buttcoin Core contributors that may
...
segwit's start date of 1 January 2017 miners can update the Buttcoin
client to Buttcoin Core 0.13.2 to signal for segwit support. When a
