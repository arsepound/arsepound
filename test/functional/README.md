...
with the arsepoundd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a arsepoundd.  `P2PInterface`
contains the higher level logic for processing P2P payloads and connecting to
the Arsepound Core node application logic. For custom behaviour, subclass the
...
Basic code to support P2P connectivity to a arsepoundd.
