...
"""Verify that starting arsepound with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arsepound with -h for help text")
        ...
        self.log.info("Start arsepound with -version for version information")
        ...
        self.log.info("Start arsepoundd with -fakearg to make sure it does not start")
