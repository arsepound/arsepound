...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.buttcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.buttcointools.com");
        vSeeds.emplace_back("dnsseed.buttcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.buttcointools.com");
        vSeeds.emplace_back("seed-b.buttcoin.loshan.co.uk");
