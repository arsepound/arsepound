...
{
    const char* pszTimestamp = "Moon, loaf and firecracker – 12 French words that actually mean ‘butt’ 15 January 2021 12:25";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1610731500, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        ...
        //vSeeds.emplace_back("seed-a.arsepound.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.arsepoundtools.com");
        //vSeeds.emplace_back("dnsseed.arsepoundpool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcd3e84ea3f16cfd3eb94b8f41bdb73e92ba8f29f04b4da2bff398511a0e5f572"));
        assert(genesis.hashMerkleRoot == uint256S("0xcd3e84ea3f16cfd3eb94b8f41bdb73e92ba8f29f04b4da2bff398511a0e5f572"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.arsepoundtools.com");
        vSeeds.emplace_back("seed-b.arsepound.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nPowTargetTimespan = 4.0 * 24 * 60 * 60; // 4.0 Days
        consensus.nPowTargetSpacing = 2.5 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
